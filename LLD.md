...
*Stores additional images for a property.*
...
*   **Query Parameters**:
    ...
    *   *Default*: Fetches apartments > 1 Cr (High value), sorted by ID DESC.
*   **Logic Flow**:
...
*   **Behavior**:
    ...
    *   Calls multiple internal APIs in parallel:
        ...
        *   `getRecommended()`
    *   Passes resolved data as *props* to `<Dashboard />`.
